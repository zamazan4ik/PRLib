...
void  calc_boundary( marklistptr list, std::vector<int>& bound_list, unsigned char ***inner_edge,unsigned char ***outer_edge, int height, int width, unsigned char ***input_img_c, unsigned char **bin_msk);
...
void flip_reversed_cc( unsigned char ***input_img, unsigned char **bin_msk, unsigned int height, unsigned int width);
